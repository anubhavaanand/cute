...
export async function getWeather(latitude: number = 28.6139, longitude: number = 77.209): Promise<WeatherData> {
  try {
...
export function getWeatherMock(): WeatherData {
  const now = new Date();
...
function getWeatherGradient(code: number, temp: number): string {
